...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label_4->setGeometry(QRect(550, 520, 63, 20));
        EvaluateLabel = new QLabel(centralwidget);
        EvaluateLabel->setObjectName("EvaluateLabel");
        EvaluateLabel->setGeometry(QRect(640, 520, 111, 20));
        EvaluateLabel->setStyleSheet(QString::fromUtf8("color: rgb(200, 9, 76)\n"
""));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        EvaluateLabel->setText(QCoreApplication::translate("MainWindow", "Loading...", nullptr));
    } // retranslateUi
